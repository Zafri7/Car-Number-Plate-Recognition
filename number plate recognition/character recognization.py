...
class Ann:
    ...
    def Forward_Input_Hidden(self):
        ...
        # print(len(net_j))
        # print(self.no_of_hidden,'no of hidden')
        # return
    ...
    def Forward_Hidden_Output(self):
        ...
        # print(len(hidden_outputs),'hidden_outputs')
        net_k = np.reshape(self.wjk @ hidden_outputs, -1)
        output_inputs = np.zeros(self.no_of_output)
        # output_inputs = np.zeros(self.no_of_hidden)
        # print(len(output_inputs))
        # print(len(self.wjk),'wjk')
        # print(len(net_k),'net_k')
        # return
        ...
        # sigmoid function
        out_k = 1 / (1 + np.exp(-(output_inputs + self.bias_k))) ########################################################change self.bias_j to self.bias_k
    ...
    def Check_for_End(self):
        ...
        self.forward_error()
        # print(self.total_error, 'TOTAL EROOR')
    ...
    def check_training_output(self):
        ...
        if len(target_output)==20:
            print(len(target_output), 'len(target_output)==20, pass', flush=True)
        else:
            for k in range(self.no_of_output):
                print(self.output[k].output, 'self.output[k].output', flush=True)
            print(target_output, 'target_output', flush=True)
...
def sobel(img):
    # img = Image.open('Training Image/A00.jpg').convert('L') 
    img_arr = np.array(img)
    # Prepare the kernels - Sober
